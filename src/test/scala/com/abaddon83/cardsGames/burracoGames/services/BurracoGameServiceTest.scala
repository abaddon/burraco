...
import com.abaddon83.cardsGames.mocks.{MockBurracoGameRepositoryAdapter, MockPlayerAdapter}
...
//    assert(gameService.createNewBurracoGame().failed.futureValue.isInstanceOf[NoSuchElementException])
//  }
//
