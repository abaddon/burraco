...
class PickUpACardFromDeckHandler() : CommandHandler<PickUpACardFromDeckCmd>, KoinComponent {
    ...
    override fun handle(command: PickUpACardFromDeckCmd) {
        ...
        val gameExecution = gameExecutionBeginning.pickUpACardFromDeck(playerIdentity = command.playerIdentity)
